package mwarehouse.warehouse.server.repository;

import mwarehouse.warehouse.entity.Product;
import mwarehouse.warehouse.entity.User;
import mwarehouse.warehouse.server.database.Configs;
import mwarehouse.warehouse.server.database.Const;
...
public class DatabaseHandler extends Configs {   //класс DatabaseHandler наследуется от Configs
    ...
    public Connection getDbConnection() throws ClassNotFoundException{
        ...
        Class.forName("com.mysql.jdbc.Driver");                             // указываем какой драйвер будем использовать
...
//        ResultSet reSet = null;
//        String yy="";
//        String sqlGetStatus = "SELECT login FROM users WHERE statusUser='0'";
//
//
//
//        try {
//            PreparedStatement prSt = getDbConnection().prepareStatement(sqlGetStatus);
//            prSt.setString(1, yy);
//            reSet = prSt.executeQuery(sqlGetStatus);
